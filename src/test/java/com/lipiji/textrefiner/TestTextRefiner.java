...
public class TestTextRefiner {
    ...
    public void toSentences() {
        String str = "This is how I tried to split a paragraph into a sentence."
        ...
        assertEquals("My paragraph includes dates like Jan. 13 , 2014 , words like U.S and numbers like 2.2 .", TextRefiner.toSentenceByStanfordNLP(str).get(2));
    }
}
